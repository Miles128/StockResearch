...
from invesbao.core.constants import AVAILABLE_SECTORS
from invesbao.core.schemas import NewsIngestOut, NewsItemOut, SectorPreferencesOut, SectorPreferencesUpdate
