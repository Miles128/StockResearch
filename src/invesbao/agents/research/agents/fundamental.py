...
from invesbao.core.constants import CONFIDENCE_HIGH, CONFIDENCE_LOW, DISCLAIMER
from invesbao.core.schemas import DimensionResult
from invesbao.data.providers.market import FinancialDataProvider

_SYSTEM = f"你是 A 股基本面分析师。{AGENT_VOICE} 不要给出买入卖出建议。末尾标注：{DISCLAIMER}"
