        ...
        (event: AgentStreamEvent) => {
          if (event.type === "status") {
            ...
            setStockImpact({
              ...
              impact_direction: (event.direction as "positive" | "negative" | "neutral") || "neutral",
                ...
                <div className="news-stock-header">
                  ...
                  <span className={`stat-pill ${impactClass(stockImpact.impact_direction)}`}>
                    ...
                    <span className={stockImpact.change_pct >= 0 ? "up" : "down"}>
                      {stockImpact.change_pct >= 0 ? "+" : ""}{stockImpact.change_pct.toFixed(2)}%
                    </span>
                  </span>
                  {stockImpact.pe_ttm != null && (
                    <span className="stat-pill">PE {stockImpact.pe_ttm.toFixed(1)}</span>
                  )}
                  <span className={`stat-pill ${stockImpact.technical_signal === "bullish" ? "up" : stockImpact.technical_signal === "bearish" ? "down" : ""}`}>
