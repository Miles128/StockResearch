...
export function IconNews({ className = "ui-icon", size = 16 }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M4.5 5.5h4M4.5 8h7M4.5 10.5h5.5"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinecap="round"
      />
...
export function IconChart({ className = "ui-icon", size = 16 }: IconProps) {
  return (
    ...
    >
      <path
        d="M2.5 13.5V4.5M6 13.5V8M9.5 13.5V6M13 13.5V2.5"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinecap="round"
      />
...
export function IconBell({ className = "ui-icon", size = 16 }: IconProps) {
  return (
    ...
    >
      <path
        d="M8 2.5a3.5 3.5 0 0 0-3.5 3.5v2.5L3 10v1h10v-1l-1.5-1.5V6A3.5 3.5 0 0 0 8 2.5Z"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinejoin="round"
      />
...
export function IconExternalLink({ className = "ui-icon", size = 16 }: IconProps) {
  return (
    ...
    >
      <path
        d="M6.5 3.5H12v5.5M12 3.5 6.5 9"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
