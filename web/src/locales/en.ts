...
export const en: Dict = {
  ...
  settings: {
    ...
    analysis: "Analysis",
    analysisHint: "Stock/market questions use multi-dimensional research by default.",
    ...
    diagnosticsTitle: "Run Diagnostics (Provider Doctor)",
    diagnosticsHint:
      "One-click check of LLM connectivity, data-source availability and environment; results stay local and never include full keys.",
    diagnosticsRun: "Run check",
    diagnosticsBusy: "Checking…",
