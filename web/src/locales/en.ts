...
export const en: Dict = {
  ...
  settings: {
    ...
    signalBacktestHint:
      "Forward returns after bullish/bearish research bias (and factor tilts) at 5/10/20 days. This is research verification, not a strategy backtester; sample bias and zero transaction costs.",
