...
export const en: Dict = {
  ...
  portfolio: {
    ...
    partial: "partial data",
    optimizeTitle: "Portfolio optimizer",
    optimizeMethodMinVol: "Min vol",
    optimizeMethodRiskParity: "Risk parity",
    optimizeMethodBalanced: "Balanced",
    optimizeError: "Optimizer unavailable, try again later",
    optimizeSymbol: "Symbol",
    optimizeCurrent: "Current",
    optimizeProposed: "Proposed",
    optimizeCash: "Cash",
    optimizeVol: "Ann. vol",
    optimizeRet: "Ann. return",
  },
  risk: {
    run: "Run checkup",
    refresh: "Refresh",
  ...
  settings: {
    ...
    predictionByRegime: "By market regime",
    predictionRegimeTrendUp: "Uptrend",
    predictionRegimeTrendDown: "Downtrend",
    predictionRegimeChoppy: "Choppy",
