...
const zh: Dict = {
  ...
  settings: {
    ...
    outputTone: "语言专业性",
    outputToneHint: "控制多维分析、多空辩论与总结的写作口吻；切换界面语言为英文时，分析内容将自动输出为英文。",
    toneProfessional: "非常专业",
    toneProfessionalHint: "投研报告口径，引用数据指标，客观克制（当前默认）",
    toneStandard: "普通",
    toneStandardHint: "清晰平衡的投研语言，术语适中",
    toneFriendly: "平易近人",
    toneFriendlyHint: "通俗解释，少用行话，适合非专业读者",
...
const en: Dict = {
  ...
  settings: {
    ...
    outputTone: "Writing style",
    outputToneHint:
      "Controls tone for research, debate, and summaries. When the UI is English, analysis output is written in English.",
    toneProfessional: "Very professional",
    toneProfessionalHint: "Institutional research tone with data citations (default)",
    toneStandard: "Standard",
    toneStandardHint: "Clear, balanced research language with moderate terminology",
    toneFriendly: "Approachable",
    toneFriendlyHint: "Plain language with fewer jargon terms for non-specialists",
