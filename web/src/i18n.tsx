...
const zh: Dict = {
  ...
  settings: {
    ...
    themeSlate: "石板靛蓝",
    themeSlateHint: "现代深色 · 靛蓝强调 · 柔和对比",
    themeWine: "改版酒红",
    themeWineHint: "纯白底 · 酒红顶栏与强调",
    themePaper: "纸张白",
    themePaperHint: "纯白底 · 中性灰边 · 蓝色强调",
    themeWarm: "暖米白",
    themeWarmHint: "纯白底 · 暖棕顶栏 · 琥珀强调",
    analysis: "分析模式",
...
const en: Dict = {
  ...
  settings: {
    ...
    themeSlate: "Slate / indigo",
    themeSlateHint: "Modern dark · indigo accent · soft contrast",
    themeWine: "Wine refined",
    themeWineHint: "Pure white · wine header & accents",
    themePaper: "Paper white",
    themePaperHint: "Pure white · neutral borders · blue accent",
    themeWarm: "Warm cream",
    themeWarmHint: "Pure white · warm brown header · amber accent",
    analysis: "Analysis",
    analysisHint:
